...
export class BookingComponent implements OnInit {
  ...
  marinaSelected() {
    // When a user clicks on any Marina spot we set spot selection to 
    //false and boat selection to active
    // When user select spot we hide the screen for selecting spot and boat 
    // selection screen is set to active
  ...
  activeSpotSelection() {
    // when user successfully selects date or stay period and clicks submit we 
    // set date selection to false (completed)
